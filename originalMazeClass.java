...
public class Maze {
	...
	private class Cell {
		...
		*/
		protected boolean canBeStart() {
			//System.out.println("in canBeStart()");
			if (getCellContent()==Content.EMPTY || getCellContent()==Content.COIN ) { //getCellContent() is problem
				//System.out.println(getCellContent());
				return true;
			}
			else return false;	//Always returns false
		}
	...
	*/
	...
	/**
	* getMazeDim() get dimension of the maze
	* 
	...
	*/	
	...
	private void setMazeStartCell(Cell startCell){
		//System.out.println("in setMazeStartCell()");
		this.mazeStartCell = startCell;
	}
	
	private Cell getMazeStartCell(){
		//System.out.println("in getMazeStartCell()");
		return this.mazeStartCell;
	}
	
	/**
	* getMazeStartCoord() get starting coordinates for the maze
	* 
	...
	*/
	...
	private void initializeMaze(){
		//System.out.println("in initializeMaze()");
	...
	{
		//System.out.println("Level outside :" + level);
		int portalX,portalY;
		if( level+1== getMazeDepth())
		{
			//System.out.println("Level inside :" + level);
		
			portalX = randomNum.nextInt(getMazeDim());
			portalY = randomNum.nextInt(getMazeDim());
			//System.out.println("CREATE MAZE LEVEL+1");
		}
		else
		{
	   ...
	   // System.out.println("Content.PORTAL_DN = " + Content.PORTAL_DN);
	...
	{
		//System.out.println("in getStart()");
		int portalX = randomNum.nextInt(getMazeDim());
		int portalY = randomNum.nextInt(getMazeDim());
		
		while (!maze[portalX][portalY][level+1].canBeStart())	//! there originally; infinite loop something is wrong here.
		{
			//System.out.println("in while loop");
			portalX = randomNum.nextInt(getMazeDim());
			portalY = randomNum.nextInt(getMazeDim());
			//System.out.println(portalX + " " + portalY);
		}
		//System.out.println("about to return maze");
		if (level < getMazeDepth()-1) maze[portalX][portalY][level==-1 ? 0:level+1].setCellContent(Content.PORTAL_UP);
		return maze[portalX][portalY][level==-1 ? 0:level];
	}
	...
	*/
	public Content[] scanAdjLoc(DroidInterface droid)
	{
		...
		for (int i=0;i<4;i++)
		{
			...
			System.out.println("aX " + adjX);
			System.out.println("aY " + adjY);
			System.out.println("mazeDim " + getMazeDim());
			System.out.println("Z" + currentCord.getZ());
